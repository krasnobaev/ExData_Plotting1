#
# This script reproduces energy sub metering linear plot to fulfill
# task 3 of Programming Assignment 1 of Exploratory Data Analysis
# course (https://class.coursera.org/exdata-004/)
#
